...
import {
  trendingHandler,
  quickTrendingHandler,
  trendingSettingsHandler,
} from "./src/commands/trending";
...
bot.command(trendingHandler.command, trendingHandler.handler);
bot.command(quickTrendingHandler.command, quickTrendingHandler.handler);
bot.command(trendingSettingsHandler.command, trendingSettingsHandler.handler);
...
bot.api.setMyCommands([
  ...
  { command: trendingHandler.command, description: trendingHandler.description },
  { command: quickTrendingHandler.command, description: quickTrendingHandler.description },
  { command: trendingSettingsHandler.command, description: trendingSettingsHandler.description },
]);
...
bot.on("callback_query:data", async (ctx) => {
  ...
  } else if (callbackData === "trending_coins") {
    await trendingHandler.handler(ctx);
  }
