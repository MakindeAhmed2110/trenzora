  ...
  handler: async (ctx: BotContext) => {
    try {
      ...
      if (!existingUser) {
        ...
        await ctx.reply(
          `🤖 *Welcome to Trenzora, the Zora MEV-Protected Trading Bot!*\n\n` +
            `Trade Zora tokens with MEV protection on the Base Network.\n\n` +
            `🧱 *Getting Started*\n` +
        ...
        await ctx.reply(
          `🤖 *Welcome back to Trenza, the Zora MEV-Protected Trading Bot!*\n\n` +
